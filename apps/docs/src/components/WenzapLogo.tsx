export function WenzapLogo({ size = 30 }: { size?: number }) {
  return (
    <div className="flex items-center gap-2.5" aria-label="Wenzap Docs">
      <svg
        width={size}
        height={size}
        viewBox="0 0 270 270"
      ...
      <span className="text-sm font-bold tracking-tight text-nb-text">Wenzap Docs</span>
    </div>
  );
}
