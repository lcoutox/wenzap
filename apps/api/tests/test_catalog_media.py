...
def _make_unlimited_plan(db: Session) -> Plan:
    ...
    plan = Plan(
        ...
        name="Test Unlimited", monthly_price_cents=0, currency="BRL",
        agents_limit=999, knowledge_bases_limit=999, sources_per_kb_limit=999,
        max_source_chars=9999999, users_limit=999, pipelines_limit=999,
        integrations_limit=999, catalog_items_limit=9999, channels_limit=999,
        monthly_ai_credits=999999, monthly_conversations=999999, is_active=True,
    )
    db.add(plan)
    db.flush()
    return plan
